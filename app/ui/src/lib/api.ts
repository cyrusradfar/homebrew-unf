...
export async function getLog(params?: GetLogParams): Promise<PaginatedLogResponse>;
export async function getLog(
	params: GetLogParams = {}
...
export async function getGlobalLog(params?: GetGlobalLogParams): Promise<PaginatedLogResponse>;
export async function getGlobalLog(
...
export async function getFileContent(params: GetFileContentParams): Promise<CatResponse> {
...
export async function getDensity(params: GetDensityParams = {}): Promise<DensityResponse> {
