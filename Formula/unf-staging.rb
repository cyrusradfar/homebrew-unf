class UnfStaging < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://downloads.unfudged.io/staging/v0.17.12/unf-v0.17.12-aarch64-apple-darwin.tar.gz"
      sha256 "5132dcc465ac69f53fe034a03aeb54dba9935c96fb0ed8a08f6571e30278eaf6"
    else
      url "https://downloads.unfudged.io/staging/v0.17.12/unf-v0.17.12-x86_64-apple-darwin.tar.gz"
